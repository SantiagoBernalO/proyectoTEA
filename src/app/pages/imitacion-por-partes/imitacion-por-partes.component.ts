...
@Component({
  selector: 'app-imitacion-por-partes',
  templateUrl: './imitacion-por-partes.component.html',
  styleUrls: ['./imitacion-por-partes.component.css']
})
export class ImitacionPorPartesComponent implements OnInit {

  public parrafo:string[];
  public seleccionado:string="Da clic en una palabra";
  ...
  async ngOnInit(): Promise<void> {
    ...
    if (this.id_decrypted != 0) {
      this.serviceActivity.getActivityId(this.id_decrypted).subscribe(data => {
        ...
        this.parrafo= this.fraseADecir.split(' ');

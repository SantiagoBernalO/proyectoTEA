...
@Component({
  selector: 'app-panelimitacion-por-partes',
  templateUrl: './panelimitacion-por-partes.component.html',
  styleUrls: ['./panelimitacion-por-partes.component.css']
})
export class PanelimitacionPorPartesComponent implements OnInit {
  ...
  actividadSeleccionada(Id_actividad){
    ...
    window.location.href = '/#/actividadImitacionPorPartes/'+this.idencrypted;
  }
